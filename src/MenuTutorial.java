...
public class MenuTutorial extends BasicGameState {
	...
	public void init(GameContainer arg0, StateBasedGame arg1)
		...
		tutorialText
				.add("Factories are where you produce your main military \n"
		...
		tutorialText
				.add("Tanks are slow, but have a a lot of health and thus\n"
		...
		tutorialText
				.add("Pirates are the scum of the galaxy. They lack proper\n"
	...
	public void update(GameContainer container, StateBasedGame game, int delta)
		...
		if (input.isKeyPressed(Input.KEY_ENTER)) {
			...
			selectedOption--;
				...
				&& selectedOption < tutorialTitle.size() - 1) {
			selectedOption++;
		}
	...
	public void render(GameContainer container, StateBasedGame game, Graphics g)
		...
		g.drawImage(tutorialImage.get(showTutorial), (float) (xText * 2.5),
				container.getHeight() / 2
						- tutorialImage.get(showTutorial).getHeight() - 50);

		g.drawString(tutorialText.get(showTutorial), (float) (xText * 2.5),
				container.getHeight() / 2);
