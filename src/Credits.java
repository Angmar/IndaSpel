...
public class Credits extends BasicGameState {
	...
	public void init(GameContainer arg0, StateBasedGame arg1)
		...
		credits.add(new String[] { "Game Design",
				"Erik Svensson\nTeodor Karlgren" });
		credits.add(new String[] { "Programming",
				"Erik Svensson\nTeodor Karlgren" });
	...
	public void render(GameContainer container, StateBasedGame game, Graphics g)
		...
		for (int i = 0; i < credits.size(); i++) {
			g.drawString(credits.get(i)[1], xText, yText + 30 + (170 * i)
					- timePassed);
		}

		g.setFont(fontTitle);
		for (int i = 0; i < credits.size(); i++) {
			g.drawString(credits.get(i)[0], xText, yText + (170 * i)
					- timePassed);
		}
	}
